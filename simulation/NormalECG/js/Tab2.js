...
var drawCurve1=function()
{
		...
		if(fz == true){
			...
			r[i] = board1.create('point',[o[i].x[11]-z,o[i].y[11]], {name:'R',face:'[]',size:2,strokeColor:'#FF0000',fillColor:'FF0000'});
			p[i] = board1.create('point',[o[i].x[6]-z,o[i].y[6]], {name:'P',face:'[]',size:2,strokeColor:'#FF0000',fillColor:'FF0000'});
			t[i] = board1.create('point',[o[i].x[17]-z,o[i].y[17]], {name:'T',face:'[]',size:2,strokeColor:'#FF0000',fillColor:'FF0000'});
			q[i] = board1.create('point',[o[i].x[9]-z,o[i].y[9]], {name:'Q',face:'[]',size:2,strokeColor:'#FF0000',fillColor:'FF0000'});
			s[i] = board1.create('point',[o[i].x[13]-z,o[i].y[13]], {name:'S',face:'[]',size:2,strokeColor:'#FF0000',fillColor:'FF0000'});
			//fz == false;			
			clearInterval(timer);
		}	
		}
...
var X=r.path("M0 10L1200 10").attr({
	...
	jQuery.fn.func2 = function(){
			...
			{	
				var x=i+cnt;
				//cordinate_X[i]=r.text(i*170,20,x).attr({'font-size':14});
